...
import '../../../view_models/home_screen_vm/home_screen_vm.dart';
import '../../../view_models/home_screen_vm/widgets/navbar_item_widget.dart';
import 'widgets/want_to_sell_widget.dart';
...
class _HomeScreenViewState extends State<HomeScreenView> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          body: Obx(() =>
              viewModel.homeScreenPages[viewModel.currentScreenIndex.value]),
