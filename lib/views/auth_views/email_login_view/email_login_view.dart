...
import '../../../../view_models/email_login_vm/email_login_vm.dart';
...
class EmailLoginView extends StatefulWidget {
  ...
  @override
  State<EmailLoginView> createState() => _LoginViewState();
}

class _LoginViewState extends State<EmailLoginView> {
  ...
  void initState() {
    ...
    viewModel = Get.put(EmailLoginViewModel());
    super.initState();
  }
